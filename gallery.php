...
#mz-gallery {
  ...
  background-image: radial-gradient(blue 1px, black 1px);
...
<section id="header">
    ...
    <div>
        <ul id="navbar">
            ...
            <li><a href="signup"><button class="button-85 barbtn" role="button">Join Us</button></a></li>
        </ul>
...
<div id="mz-gallery">
  ...
  <figure>
    <img src="gallery/2023_12_08_14_38_IMG_8783.JPG" alt="Statue of Liberty" width="700" height="700">
  ...
  <figure>
    <img src="gallery/2024_02_04_12_00_IMG_0128.JPG" alt="Night Sky" width="700" height="700">
    <figcaption>Integration Day !</figcaption>
    <div></div>
    <div></div>
    <div></div>
    <div></div>
  ...
  <figure>
    <img src="gallery/2024_02_14_15_13_IMG_0507.JPG" alt="Ravine Between Rocks" width="700" height="700">
    <figcaption>Content Creation Through AI</figcaption>
    <div></div>
    <div></div>
    <div></div>
    <div></div>
  ...
  <figure>
    <img src="gallery/2024_02_21_12_50_IMG_0718.JPG" alt="Wheat Farm" width="700" height="700">
    <figcaption>Sponsoring & Soft Skills</figcaption>
    <div></div>
    <div></div>
    <div></div>
    <div></div>
  ...
  <figure>
    <img src="gallery/2024_02_18_17_07_IMG_0646.JPG" alt="City Street" width="700" height="700">
    <figcaption>Web Development Workshop</figcaption>
    <div></div>
    <div></div>
    <div></div>
    <div></div>
  ...
  <figure>
    <img src="gallery/IMG_2924.jpg" alt="Crumbling Pier" width="700" height="700">
    <figcaption>Digital Culture Days</figcaption>
    <div></div>
    <div></div>
    <div></div>
    <div></div>
